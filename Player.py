...
class Player:
    ...
    def add_song(self):
        ...
        print("Song name",song_path)
        print("song value",song_name)
    ...
    def add_song_to_favourites(self,song_name):
        ...
        res=self.my_model.add_song_to_favourites(song_name,song_path)
        return res
    def load_songs_from_favourites(self):
        song_val=self.my_model.load_songs_from_favourites()
        return song_val,self.my_model.song_dict
    def remove_song_from_favorites(self,song_name):
        res=self.my_model.remove_song_from_favorites(song_name)
        return res
...
if __name__=="__main__":
     p=Player()
     print("DB Connection open",p.get_db_status())
     p.add_song()
